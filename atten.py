...
class Model(nn.Module):
    def __init__(self, n_words, n_labels, n_tags, n_embed=100, n_feat_embed=100, embed_dropout=.33, 
        ...
        self.feat_biaffine = BiAAttention(input_size_encoder=n_label_mlp, 
                                          input_size_decoder=n_label_mlp, 
                                          num_labels=n_labels, biaffine=False)
...
def train(model, traindata, devdata, optimizer):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if dev_metric > best_metric:
            ...
            torch.save(model.state_dict(), "biatt_model_False.pt")
